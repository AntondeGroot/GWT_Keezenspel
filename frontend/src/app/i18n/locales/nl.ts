...
export const nl: Dictionary = {
  ...
  tradeOfferTitle: 'Vraag je teamgenoot',
  tradeOfferSub: 'Kies een kaart om te geven en vraag om een Heer of Aas.',
  tradeAsk: 'Vraag',
  tradeClose: 'Sluiten',
  tradeWaitingTitle: 'Wachten…',
  tradeWaitingSub: 'Wachten tot %s reageert…',
