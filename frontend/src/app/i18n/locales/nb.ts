...
export const nb: Dictionary = {
  ...
  tradeOfferTitle: 'Spør lagkameraten',
  tradeOfferSub: 'Velg et kort å gi, og be om en Konge eller Ess.',
  tradeAsk: 'Spør',
  tradeClose: 'Lukk',
  tradeWaitingTitle: 'Venter…',
  tradeWaitingSub: 'Venter på svar fra %s…',
