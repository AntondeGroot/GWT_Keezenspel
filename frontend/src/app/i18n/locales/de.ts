...
export const de: Dictionary = {
  ...
  tradeOfferTitle: 'Frag deinen Teamkollegen',
  tradeOfferSub: 'Wähle eine Karte zum Geben und bitte um einen König oder ein Ass.',
  tradeAsk: 'Bitten',
  tradeClose: 'Schließen',
  tradeWaitingTitle: 'Warten…',
  tradeWaitingSub: 'Warte auf Antwort von %s…',
