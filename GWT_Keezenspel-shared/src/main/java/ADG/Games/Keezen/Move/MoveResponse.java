...
public class MoveResponse implements IsSerializable {
  ...
  /**
   * Only use this server side in OnMove to check if any pawn was killed when you want to
  ...
  public String toString() {
    ...
    if (pawnIdKilled1 != null)
      sb.append("    pawnId Killed 1 = ").append(pawnIdKilled1).append(",\n");
    if (pawnIdKilled2 != null)
      sb.append("    pawnId Killed 2 = ").append(pawnIdKilled2).append(",\n");
    ...
    if (moveKilledPawn1 != null)
      sb.append("    moveKilledPawn 1 = ").append(moveKilledPawn1).append(",\n");
    if (moveKilledPawn2 != null)
      sb.append("    moveKilledPawn 2 = ").append(moveKilledPawn2).append(",\n");
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(pawnId1, that.pawnId1)
        && Objects.equals(pawnId2, that.pawnId2)
        && Objects.equals(pawnIdKilled1, that.pawnIdKilled1)
        && Objects.equals(pawnIdKilled2, that.pawnIdKilled2)
        && Objects.equals(movePawn1, that.movePawn1)
        && Objects.equals(movePawn2, that.movePawn2)
        && Objects.equals(moveKilledPawn1, that.moveKilledPawn1)
        && Objects.equals(moveKilledPawn2, that.moveKilledPawn2)
