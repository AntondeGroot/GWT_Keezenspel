 ...
 * TestMoveResponse:
 *   type: object
 *   description: only returns PositionKeys you need to highlight for possible moves
 *   properties:
 *     tiles:
 *       $ref: '#/components/schemas/MoveSet' (array of PositionKey)
 */
public class TestMoveResponseDTO extends JavaScriptObject {
  ...
  /**
   * Returns the list of tile positions (array of PositionKeyDTO)
