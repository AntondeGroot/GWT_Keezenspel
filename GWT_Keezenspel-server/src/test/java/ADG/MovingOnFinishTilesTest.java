...
import static ADG.GameStateUtil.*;
import static ADG.MoveResult.CANNOT_MAKE_MOVE;
import static ADG.MoveResult.CAN_MAKE_MOVE;
...
class MovingOnFinishTilesTest {
    ...
    void moveFromLastSectionOntoFinish(){
        ...
        Pawn pawn1 = GameStateUtil.createPawnAndPlaceOnBoard(1, new TileId(0,14));
