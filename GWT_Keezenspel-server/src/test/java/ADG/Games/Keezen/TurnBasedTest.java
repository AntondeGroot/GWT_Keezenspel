...
public class TurnBasedTest {
    ...
    void player1Forfeits_Player1NoCards_OthersStillHaveCards() {
        ...
        nrCardsPerPlayer.add(5);
        assertEquals(nrCardsPerPlayer, ADG.Games.Keezen.CardsDeck.getNrOfCardsForAllPlayers());
    }
    @Test
    ...
    void player2Forfeits_WhenPlayer1HasPlayed_Player3WillPlayNext(){
        ...
        // THEN
        assertTrue(ADG.Games.Keezen.CardsDeck.getCardsForPlayer(1).isEmpty());
    ...
    void allPlayersExcept1Forfeit_RemainingPlayerKeepsPlayingUntilLastCard(){
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if(i < 4){
                ...
                assertEquals("cards remaining for player 2"+i,4-i, ADG.Games.Keezen.CardsDeck.getCardsForPlayer(2).size());
            }
        }
    }
    @Test
