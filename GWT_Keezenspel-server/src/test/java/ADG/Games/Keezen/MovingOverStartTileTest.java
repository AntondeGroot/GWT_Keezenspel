...
class MovingOverStartTileTest {
    ...
    void passingStartTile1_0Forward_NotPossibleWhenPlayerIsThere_PawnMovesBackwards(){
        ...
        Pawn pawn1 = GameStateUtil.placePawnOnNest("0",new TileId("0",15));
        Pawn pawn2 = placePawnOnNest("1",new TileId("1",0));
    ...
    void movingOverStartTile0_0Forwards_NotPossibleWhenPlayerIsThere_PawnMovesBackwards(){
        ...
        Pawn pawn2 = placePawnOnNest("1",new TileId("7",10));
    ...
    void passingStartTile0_0Backwards_NotPossibleWhenPlayerIsThere_PawnMovesForward(){
        ...
        Pawn pawn1 = placePawnOnNest("0",new TileId("0",0));
        Pawn pawn2 = placePawnOnNest("1",new TileId("0",3));
    ...
    void passingStartTile1_0Backward_NotPossibleWhenPlayerIsThere_PawnMovesForward(){
        ...
        Pawn pawn1 = placePawnOnNest("0", new TileId("1",2));
        Pawn pawn2 = placePawnOnNest("1", new TileId("1",0));
    ...
    void passingStartTile1_0Backward_PossibleWhenOtherPlayerIsThere_PawnMovesBackward(){
        ...
        Pawn pawn1 = placePawnOnNest("1", new TileId("1",2));
        Pawn pawn2 = placePawnOnNest("0", new TileId("1",0));
    ...
    void PawnMovesBackward_EndsOnStart(){
        ...
        Pawn pawn1 = placePawnOnNest("1", new TileId("1",1));
    ...
    void PawnMovesForward_EndsOnStart(){
        ...
        Pawn pawn1 = placePawnOnNest("1", new TileId("1",15));
    ...
    void PawnMovesBackwardFromStartTile1_0ToPreviousSection(){
        ...
        Pawn pawn1 = placePawnOnNest("0", new TileId("1",0));
    ...
    void pawnEndOnOccupiedStartTileBackwards_Blockade_EndsOnTile2(){
        // GIVEN
        Card card = givePlayerCard(0,-4);
        Pawn pawn1 = placePawnOnBoard(new PawnId("0",1), new TileId("0",4));
        Pawn pawn2 = placePawnOnBoard(new PawnId("0",2), new TileId("0",0));
    ...
    void pawnEndOnOccupiedStartTileBackwards_NoBlockade_CannotMove(){
        // GIVEN
        Card card = givePlayerCard(1,-4);
        Pawn pawn1 = placePawnOnBoard(new PawnId("1",1), new TileId("0",4));
    ...
    void pawnEndOnOccupiedStartTileBackwards_Tile2IsAlsoOccupied_CannotMove(){
        ...
        Pawn pawn1 = placePawnOnBoard(new PawnId("0",1), new TileId("0",4));
        Pawn pawn2 = placePawnOnBoard(new PawnId("0",2), new TileId("0",0));
        Pawn pawn3 = placePawnOnBoard(new PawnId("0",3), new TileId("0",2));
    ...
    void pawnEndOnOccupiedStartTileForwards_NoBlockade_CannotMove(){
        // GIVEN
        Card card = givePlayerCard(1,4);
        Pawn pawn1 = placePawnOnBoard(new PawnId("1",1), new TileId("7",12));
        Pawn pawn2 = placePawnOnBoard(new PawnId("1",2), new TileId("0",0));
    ...
    void pawnEndOnOccupiedStartTileForwards_Blockade_Tile14IsAlsoOccupied_CannotMove(){
        ...
        Card card = givePlayerCard(1,4);
        Pawn pawn1 = placePawnOnBoard(new PawnId("1",1), new TileId("7",12));
        Pawn pawn2 = placePawnOnNest("0", new TileId("0",0));
        Pawn pawn3 = placePawnOnBoard(new PawnId("1",2), new TileId("7",14));
    ...
    void canPassStartTileSamePlayerWhenPawnOnDifferentStartTile(){
        ...
        Pawn pawn1 = placePawnOnBoard(new PawnId("2",1), new TileId("0",15));
        Pawn pawn2 = placePawnOnBoard(new PawnId("2",2), new TileId("1",0));
    ...
    void canPassStartTileBackWards_SamePlayer_WhenPawnOnDifferentStartTile(){
        // GIVEN
        Card card = givePlayerCard(2,-4);
        Pawn pawn1 = placePawnOnBoard(new PawnId("2",1), new TileId("1",2));
        Pawn pawn2 = placePawnOnBoard(new PawnId("2",2), new TileId("1",0));
    ...
    void canPassStartTile_DifferentPlayerOnDifferentStartTile(){
        ...
        Card card = givePlayerCard(2,4);
        Pawn pawn1 = placePawnOnBoard(new PawnId("2",1), new TileId("0",15));
        Pawn pawn2 = placePawnOnBoard(new PawnId("0",2), new TileId("1",0));
