...
public class ProcessOnSwitch {
  public static void processOnSwitch(
      GameState gameState, MoveRequest moveMessage, MoveResponse moveResponse) {
    //
    ...
    //        if(!playerId.equals(selectedPawnPlayerId1) &&
    // (!playerId.equals(selectedPawnPlayerId2))){
    //            moveResponse.setResult(CANNOT_MAKE_MOVE);
    //            return;
    //        }
